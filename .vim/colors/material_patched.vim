...
hi clear
syntax reset
let g:colors_name = "material_patched"

" Highlighting Function
fun <sid>hi(group, ctermfg, attr)
  if a:ctermfg != ""
...
call <sid>hi("Conceal",       s:cterm07, "")
call <sid>hi("Cursor",        "", "")
call <sid>hi("NonText",       s:cterm08, "")
call <sid>hi("Normal",        s:cterm0F, "")
call <sid>hi("LineNr",        s:cterm06, "")
call <sid>hi("SignColumn",    s:cterm08, "")
call <sid>hi("SpecialKey",    s:cterm0D, "")
call <sid>hi("StatusLine",    s:cterm0F, "none")
call <sid>hi("StatusLineNC",  s:cterm06, "none")
call <sid>hi("VertSplit",     s:cterm00, "none")
call <sid>hi("ColorColumn",   "", "none")
call <sid>hi("CursorColumn",  "", "none")
call <sid>hi("CursorLine",    "", "none")
call <sid>hi("CursorLineNr",  s:cterm08, "")
call <sid>hi("PMenu",         s:cterm06, "none")
call <sid>hi("PMenuSel",      s:cterm0A, "")
call <sid>hi("TabLine",       s:cterm08, "none")
call <sid>hi("TabLineFill",   s:cterm08, "none")
call <sid>hi("TabLineSel",    s:cterm08, "none")
...
" Diff Highlighting
call <sid>hi("DiffAdd",      s:cterm0E, "")
call <sid>hi("DiffChange",   s:cterm08, "")
call <sid>hi("DiffDelete",   s:cterm0C, "")
call <sid>hi("DiffText",     s:cterm0D, "")
call <sid>hi("DiffAdded",    s:cterm0C, "")
call <sid>hi("DiffFile",     s:cterm0C, "")
call <sid>hi("DiffNewFile",  s:cterm06, "")
call <sid>hi("DiffLine",     s:cterm0D, "")
call <sid>hi("DiffRemoved",  s:cterm0D, "")
...
call <sid>hi("GitGutterAdd",          s:cterm0D, "")
call <sid>hi("GitGutterChange",       s:cterm06, "")
call <sid>hi("GitGutterDelete",       s:cterm0D, "")
call <sid>hi("GitGutterChangeDelete", s:cterm06, "")
...
call <sid>hi("markdownError",            s:cterm0B, "")
...
call <sid>hi("pythonClassDef",    s:cterm0E, "")
